  ...
  return (
    <div className='dark:bg-gray-950'>
        <div className="container px-4">
            <div className="grid grid-cols-1 md:grid-cols-3 pb-12 md:pb-20 pt-5 gap-4">
                {/*company detail*/}
                <div className='py-6 sm:py-8 px-2 sm:px-4'>
                    ...
                    <p className='text-gray-600 dark:text-white/70 lg:pr-24 pt-3 text-sm sm:text-base'>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ratione excepturi sint eaque cum odio vitae necessitatibus.
                    </p>
                    <p className='text-gray-500 mt-4 text-sm'>Pagina realizada por Two Brother's Design Web</p>
                    <a href="https://www.youtube.com/watch?v=EfKqSnXfCzQ" target='_blank' className='inline-block bg-primary/90 text-white py-2 px-4
                    mt-4 text-sm rounded-full min-h-[40px]'>Visita nuestro canal de Youtube</a>
                </div>
                {/*Footer Links*/}
                <div className='md:col-span-2 grid grid-cols-1 sm:grid-cols-3 md:pl-10 gap-2'>
                ...
                {/*Company address*/}
                <div className='py-6 sm:py-8 px-2 sm:px-4 col-span-1 sm:col-auto justify-center'>
